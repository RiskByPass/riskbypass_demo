...
# 需要过datadome的网站
target_url = 'https://www.mouser.com/'
...
ddjskey = '2211F522B61E269B869FA6EAFFB5E1'
...
ddoptions = json.dumps({"ajaxListenerPath":True,"allowHtmlContentTypeOnCaptcha":True})
...
if not datadome_cookie:
    ...
    for i in range(10):
        ...
        try:
            response = request(method='GET', url='https://www.mouser.com/new/infineon/infineon-psoc-control-mcus/', headers=headers, impersonate='chrome136', proxies={'https':proxy}, cookies=json.loads(datadome_cookie))
            print(response.text)

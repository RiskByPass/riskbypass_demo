...
PROXY    = f"http://username:password@host:port"         # Proxy string
...
if __name__ == "__main__":
    ...
    h = kasada_args.get('x-kpsdk-h') or '01LAYcQHBsrRxyq9ja+CNVxPZlQ9g=' # Get the x-kpsdk-h
    fc = ''
